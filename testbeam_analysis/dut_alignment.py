...
def prealignment(input_correlation_file, output_alignment_file, z_positions, pixel_size, s_n=0.1, fit_background=False, reduce_background=True, dut_names=None, no_fit=False, non_interactive=True, iterations=3, plot=True):
