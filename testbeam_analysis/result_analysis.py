...
def calculate_residuals(input_tracks_file, input_alignment_file, use_prealignment, select_duts, n_pixels, pixel_size, output_residuals_file=None, dut_names=None, nbins_per_pixel=None, npixels_per_bin=None, use_fit_limits=False, plot=True, cluster_size_selection=None, chunk_size=1000000):
...
def calculate_purity(input_tracks_file, input_alignment_file, use_prealignment, bin_size, sensor_size, select_duts, output_purity_file=None, pixel_size=None, n_pixels=None, minimum_hit_density=10, cut_distance=None, col_range=None, row_range=None, show_inefficient_events=False, output_file=None, plot=True, chunk_size=1000000):
