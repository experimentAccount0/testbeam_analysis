...
def apply_alignment(hits_x, hits_y, hits_z, dut_index, alignment=None,
                    prealignment=None, inverse=False, doTranslation = True):
    ...
    doTranslation: bool
        if True, apply translation and rotation, if False only rotation
        This to discriminate between position (translation+rotation) and error (only rotation)
