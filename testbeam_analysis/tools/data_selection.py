...
def combine_hit_files(input_hit_files, output_hit_file=None, event_number_offsets=None, chunk_size=10000000):
...
def reduce_events(input_file, max_events, output_file=None, chunk_size=10000000):
    ...
    with tb.open_file(input_file, mode='r') as in_file:
        with tb.open_file(output_file, mode="w") as out_file:
            for node in in_file.root:
                ...
                tracks_table_out = out_file.create_table(out_file.root,
                                                         name=node.name,
...
def select_tracks(input_tracks_file, select_duts, output_tracks_file=None, condition=None, max_events=None, duts_hit_selection=None, duts_no_hit_selection=None, duts_quality_selection=None, duts_no_quality_selection=None, chunk_size=10000000):
