...
def plot_residuals_vs_position(hist, xedges, yedges, xlabel, ylabel, res_mean=None, res_mean_err=None, res_pos=None, selection=None, title=None, fit=None, cov=None, fit_limit=None, output_pdf=None):
...
def plot_track_density(input_tracks_file, z_positions, dim_x, dim_y, pixel_size, mask_zero=True, use_duts=None, max_chi2=None, output_pdf_file=None):
