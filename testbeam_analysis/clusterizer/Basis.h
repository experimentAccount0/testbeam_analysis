#pragma once
//Base class providing often used functions (e.g. function that
...
#pragma warning(disable: 4996) //disable 'std::copy': Function call warning with parameters that may be unsafe
