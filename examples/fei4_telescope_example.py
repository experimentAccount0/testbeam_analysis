...
#     tba.align_z(track_candidates_file=output_folder + r'/TrackCandidates.h5',
#                 alignment_file=output_folder + r'/Alignment.h5',
#                 output_pdf=output_folder + r'/Z_positions.pdf',
...
#                 warn_at=0.5)
    ...
    tba.fit_tracks(track_candidates_file=output_folder + r'/TrackCandidates.h5',
...
#     tba.calculate_residuals(tracks_file=output_folder + r'/Tracks.h5',
...
#     tba.calculate_efficiency(tracks_file=output_folder + r'/Tracks.h5',
