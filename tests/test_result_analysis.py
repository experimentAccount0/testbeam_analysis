...
#         os.remove(cls.output_folder + 'Tracks.h5')
    ...
    def test_residuals_calculation(self):
        tba.calculate_residuals(tracks_file=tests_data_folder + 'Tracks_result.h5',
...
#         compare_h5_files(tests_data_folder + 'TrackCandidates_result.h5', self.output_folder + 'TrackCandidates.h5')
    ...
    def test_efficiency_calculation(self):
        tba.calculate_efficiency(tracks_file=self.output_folder + 'Tracks_result.h5',
                                 ...
                                 col_range=(5, 70),
                                 row_range=(20, 320))
#         compare_h5_files(tests_data_folder + 'TrackCandidates_result.h5', self.output_folder + 'TrackCandidates.
